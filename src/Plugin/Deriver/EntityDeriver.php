...
/**
 * @file
 * Contains \Drupal\simple_rest\Plugin\Deriver\EntityDeriver.
 */

namespace Drupal\simple_rest\Plugin\Deriver;
 ...
 *
 * @see \Drupal\simple_rest\Plugin\rest\resource\EntityResource
 */
      ...
      foreach ($this->entityManager->getDefinitions() as $entity_type_id => $entity_type) {
        ...
        foreach ($default_uris as $link_relation => $default_uri) {
          ...
          if ($link_template = $entity_type->getLinkTemplate($link_relation)) {
            $this->derivatives[$id]['uri_paths'][$link_relation] = $link_template;
          }
          else {
            $this->derivatives[$id]['uri_paths'][$link_relation] = $default_uri;
          }
        }
